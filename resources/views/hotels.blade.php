...
<script type="text/javascript">
    $(document).ready(function(e){
        ...
        $('#search').click(function(e){
            ...
            $.get('{{route('availableHotels')}}', {from_date : from, to_date: to, city: city, adults: adults, search: filters}, function(resp){
                drawResponse(resp);
            })
        });
    });
    ...
    function drawResponse(resp) {
        ...
        resp.forEach(function(element, index){
            $('<tr>').append($('<td>').text(index + 1))
                ...
                .append($('<td>').text(element.rate))
                .append($('<td>').text(element.fare))
                .append($('<td>').text(element.amenities))
                .appendTo($('tbody'))
        })
    }
</script>
